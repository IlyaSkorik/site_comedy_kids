...
<head>
    <meta charset="UTF-8">
    <title>Редактировать преподавателя — COMEDY KIDS</title>
    ...
    <div class="admin-container">
        ...
        <main class="main-content">
            <header class="admin-header">
                <h1>✏️ Редактировать преподавателя</h1>
            ...
            <form action="edit-process.php" method="post" enctype="multipart/form-data" class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="role" value="<?= htmlspecialchars($teacher['role']) ?>" required>
                </div>

                <div class="form-group">
                    <label>Опыт работы </label>
                    <input type="text" name="experience" value="<?= htmlspecialchars($teacher['experience']) ?>" >
                </div>

                <div class="form-group">
                    <label>Достижения (по одному на строку)</label>
                    <textarea name="achievements" rows="4" placeholder="Чемпион Высшей лиги&#10;Лучший сценарист"><?= htmlspecialchars(implode("\n", $teacher['achievements'])) ?></textarea>
                </div>

                <div class="form-group">
                    <label>Цитата преподавателя </label>
                    <textarea name="quote" rows="3" ><?= htmlspecialchars($teacher['quote']) ?></textarea>
                </div>

                <div class="form-group">
                    <label>Текущее фото</label>
                    <img src="<?= htmlspecialchars($teacher['image']) ?>" alt="Текущее фото" style="max-width: 250px; border-radius: 10px;">
                </div>
